...
9. Change Menu language to Japanese and confirm the native File/View menu labels, empty start surface, workspace labels, preview unavailable messages, Preferences labels, and Agent Workbench mode-gate copy update.
