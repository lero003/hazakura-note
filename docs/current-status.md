...
- The current-file Outline pane lists ATX Markdown headings outside fenced code blocks and jumps the editor to the selected heading line.
...
- Go to Line control
- Current-file Markdown heading outline with click-to-jump navigation
