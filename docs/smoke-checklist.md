...
9. Change Menu language to Japanese and confirm the native File/View menu labels, empty start surface, Preferences labels, and Agent Workbench mode-gate copy update.
