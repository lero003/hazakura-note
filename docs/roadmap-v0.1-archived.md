# Archived Roadmap: v0.1 Planning Series

Status: Archive
Scope: Historical development sequence through the early v0.1 planning series
Authority: Low
Last reviewed: 2026-05-28

This document preserves the original roadmap numbering and historical phase notes.
It is no longer the current planning source. Use `docs/roadmap.md` for the active roadmap.
